...
public class add_electronic_product extends AppCompatActivity {

    private static final int SELECT_IMAGE = 234;
    int click_count;
    String item, category, user_id, document_id, shop_id, shop_name = "", shop_image = "";
    EditText name, brand, price, mrp, size, description;
    TextView submit;
    ImageView image0, image1, image2, image3, image4;
    String names, brands, prices, mrps, extras, sizes = "-1", descriptions, stock;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_electronic_product);
